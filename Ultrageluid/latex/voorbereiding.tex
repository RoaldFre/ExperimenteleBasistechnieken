...
\end{equation}
\figuur{width=0.7\textwidth}{bulk}{Illustratie van de bulk modulus}
...
\figuurOctave{dispersie}{Impressie van een disperserende sinusburst gemoduleerd 
door een blokgolf}
...
\figuurOctave{delayamp}{Piekamplitude rond de resonantiefrequentie}
